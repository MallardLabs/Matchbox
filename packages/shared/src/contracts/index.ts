...
export const CONTRACTS = {
  testnet: {
    ...
    validatorsVoter: getAddress("0xac1bA4627d2Ec488bEdd562bB857275C45003844"),
    thirdPartyVoter: getAddress("0x62FE6d71BE2Ac2806Da046bf93b02C279246251D"),
    validatorPool: getAddress("0x7B7C000000000000000000000000000000000011"),
  ...
  mainnet: {
    ...
    poolsVoter: getAddress("0x48233cCC97B87Ba93bCA212cbEe48e3210211f03"),
    validatorsVoter: getAddress("0xe99a9ad5Ed26BD30e4DB25397f378817e9b9515a"),
    thirdPartyVoter: getAddress("0x2e6D2F2CaCC1d24F9f9358030674eB307397A6EB"),
    validatorPool: getAddress("0x7B7C000000000000000000000000000000000011"),
...
// View surface of the veMEZO third-party voter (a NonStakingVoter). Gauges
// are the votable unit, so votes key on the gauge address.
export const NON_STAKING_VOTER_ABI = [
  {
    inputs: [{ internalType: "address", name: "", type: "address" }],
    name: "isAlive",
    outputs: [{ internalType: "bool", name: "", type: "bool" }],
...
export const VALIDATOR_POOL_ABI = [
  {
    inputs: [],
    name: "validators",
    outputs: [{ internalType: "address[]", name: "", type: "address[]" }],
  ...
  },
  {
    ...
    name: "validator",
    outputs: [
      { internalType: "bytes32", name: "consPubKey", type: "bytes32" },
      {
        components: [
        ...
        internalType: "struct IValidatorPool.Description",
        name: "description",
        type: "tuple",
      },
    ],
...
export const THIRD_PARTY_VOTER_ABI = [
  {
    inputs: [{ internalType: "address", name: "", type: "address" }],
    name: "gaugeToBribe",
    outputs: [{ internalType: "address", name: "", type: "address" }],
