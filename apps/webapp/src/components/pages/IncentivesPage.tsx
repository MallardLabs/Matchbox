          ...
          <SpringIn delay={0} variant="card">
            <Card withBorder overrides={{}}>
              <div className="py-4">
                ...
                {selectedLock && (
                  <div className="mt-4 grid grid-cols-1 gap-3 rounded-lg bg-[var(--surface-secondary)] p-4 min-[480px]:grid-cols-2 lg:grid-cols-4">
                    <div>
          ...
          {selectedLock &&
            (!hasGauge && !isLoadingGauge ? (
              ...
              <>
                {/* Tab Navigation */}
                <SpringIn delay={1} variant="card">
                  <div className="grid grid-cols-1 gap-1 rounded-lg bg-[var(--surface-secondary)] p-1 sm:grid-cols-3">
                    {(
                      [
                        ...
                        <div className="flex flex-col gap-6 py-4">
                          ...
                          <div>
                            ...
                            <div className="grid gap-4 sm:grid-cols-2">
                              <div>
                                <label
                                  htmlFor="gauge-twitter"
                                  className="mb-1 flex items-center gap-2 text-2xs uppercase tracking-wider text-[var(--content-tertiary)]"
                                >
                                  <TwitterIcon size={14} />
                                  Twitter / X
                                </label>
                  ...
                  <SpringIn delay={2} variant="card">
                    <Card title="Gauge Analytics" withBorder overrides={{}}>
                      <div className="py-8 text-center">
                        ...
                        <div className="mx-auto mt-6 grid max-w-lg grid-cols-1 gap-4 sm:grid-cols-3">
                          <div className="rounded-lg bg-[var(--surface-secondary)] p-4">
                            <p className="mb-1 text-2xs uppercase tracking-wider text-[var(--content-tertiary)]">
                              Current Boost
                            </p>
