...
async function handler(request: Request): Promise<Response> {
  ...
  try {
      ...
      return new Response(
        JSON.stringify({
          ...
          totals: {
            ...
            newLockVeMezoWad: "0",
            extensionMezoWad: "0",
            extensionVeMezoWad: "0",
            voteWeightEpochAggregateWad: "0",
            totalEpochs: 0,
    ...
    const serializedTotals = {
      ...
      newLockMezoWad: simResult.totals.newLockMezoWad.toString(),
      newLockVeMezoWad: simResult.totals.newLockVeMezoWad.toString(),
      extensionMezoWad: simResult.totals.extensionMezoWad.toString(),
      extensionVeMezoWad: simResult.totals.extensionVeMezoWad.toString(),
      voteWeightEpochAggregateWad:
        simResult.totals.voteWeightEpochAggregateWad.toString(),
